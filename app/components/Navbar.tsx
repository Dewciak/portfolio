...
const Navbar = () => {
  ...
  return (
    <div className='py-8 w-full fixed  px-16 bg-[#01000e]'>
      <div className='hidden lg:flex items-center justify-between w-full mx-auto'>
        <OpenForWork />
      ...
      <motion.div
        className='mobile-menu flex flex-col  w-[450px] ml-auto mt-16 absolute right-14'
